	...
	**/
	...
	$(function () {
		...
		**/
		...
		$('.header').on('click', '.bubul', function () {
			if ($('.menu-full-overlay').hasClass('visible')) {
				$('.menu-full-overlay').removeClass('visible');
				$('.menu-btn.full').removeClass('active');
				$('body').removeClass('no-scroll');
				$('.menu-full-overlay').addClass('is-open');
				$('.menu-full-overlay').addClass('has-scroll');
				$('.menu-full-overlay').addClass('animate-active');
				setTimeout(function () {
					$('.menu-full-overlay').removeClass('visible');
					$('.menu-btn.full ').removeClass('no-touch');
				}, 1000);
				// $('.menu-full-overlay').removeClass('active');
				// $('.menu-full-overlay').removeClass('visible');}
				// $('.menu-full-overlay').removeClass('visible');}
				// $('.menu-full-overlay').addClass('has-scroll');
			}
